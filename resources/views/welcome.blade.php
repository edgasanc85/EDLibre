                ...
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-lg-5 text-center text-lg-end">
                        <div class="d-flex flex-column gap-3 align-items-center align-items-lg-end">
                            <a href="https://github.com" target="_blank" class="btn-glow text-decoration-none d-flex align-items-center justify-content-center gap-2 w-100" style="max-width: 320px;">
